...
import os
os.system("rm BITCOINs_2016.json")
#os.system("rm BTC_2016.json")

os.system("wget http://coinmarketcap.northpole.ro/api/v5/history/BTC_2016.json")

data_file= open('BTC_2016.json')   
...
iterer = 0
print "                "
print "               Value BITCOINs in 10 Days"
print "                "
last_10_days_prices = []
last_10_days_dates = []
...
print "                "
print "              Minimum Value BITCOINs in Date"
print "                "
...
print "                "
print "              Maximum Value BITCOINs in Date"
print "                "
...
iterer = 0
print "                "
print "  10 Maximum Values del BITCOINs in Dates"
print "                "
...
iterer = 0
print "                "
print "  10 Minimum Values del BITCOINs in Dates"
print "                "
...
iterer = 0
print "                "
print "               Value BITCOINs in 30 Days"
print "                "
last_30_days_prices = []
last_30_days_dates = []
for dict_dia_a_dia in n_dict:
